    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                string myTempFile = Path.Combine(Path.GetTempPath(), "TwentyOneGamelog.txt");
                using (StreamWriter file = new StreamWriter(myTempFile, true))
                {
        ...
        //Since all exceptions inherit from Exception, you can pass in any exception here, including
        //the any custom exception that inherits from Exception.
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                //By naming the datatype you are protecting against Sql Injection.
